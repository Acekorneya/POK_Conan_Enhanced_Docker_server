...
log_effective_server_settings() {
  ...
  log_info "Death and avatars: DropEquipment=${DROP_EQUIPMENT_ON_DEATH:-true} DropBackpack=${DROP_BACKPACK_ON_DEATH:-true} EverybodyCanLootCorpse=${EVERYBODY_CAN_LOOT_CORPSE:-true} Avatars=${AVATAR_ENABLED:-true} MaxNudity=${MAX_NUDITY:-0}"
